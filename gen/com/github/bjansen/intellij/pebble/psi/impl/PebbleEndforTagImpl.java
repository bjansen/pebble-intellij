...
public class PebbleEndforTagImpl extends ASTWrapperPsiElement implements PebbleEndforTag {

  public PebbleEndforTagImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PebbleVisitor visitor) {
    visitor.visitEndforTag(this);
  }
