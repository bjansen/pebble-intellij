...
public class PebbleEndifTagImpl extends ASTWrapperPsiElement implements PebbleEndifTag {

  public PebbleEndifTagImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PebbleVisitor visitor) {
    visitor.visitEndifTag(this);
  }
