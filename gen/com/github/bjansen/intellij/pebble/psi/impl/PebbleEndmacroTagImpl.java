...
public class PebbleEndmacroTagImpl extends ASTWrapperPsiElement implements PebbleEndmacroTag {

  public PebbleEndmacroTagImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PebbleVisitor visitor) {
    visitor.visitEndmacroTag(this);
  }
