...
public class PebbleEndfilterTagImpl extends ASTWrapperPsiElement implements PebbleEndfilterTag {

  public PebbleEndfilterTagImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PebbleVisitor visitor) {
    visitor.visitEndfilterTag(this);
  }
