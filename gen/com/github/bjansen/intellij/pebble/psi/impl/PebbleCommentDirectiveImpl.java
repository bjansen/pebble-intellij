...
public class PebbleCommentDirectiveImpl extends ASTWrapperPsiElement implements PebbleCommentDirective {

  public PebbleCommentDirectiveImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PebbleVisitor visitor) {
    visitor.visitCommentDirective(this);
  }
