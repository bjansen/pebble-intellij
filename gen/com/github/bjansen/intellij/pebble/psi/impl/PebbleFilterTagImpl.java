...
public class PebbleFilterTagImpl extends ASTWrapperPsiElement implements PebbleFilterTag {

  public PebbleFilterTagImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PebbleVisitor visitor) {
    visitor.visitFilterTag(this);
  }
  ...
  @Override
  @NotNull
  public PebbleEndfilterTag getEndfilterTag() {
    return findNotNullChildByClass(PebbleEndfilterTag.class);
  }
