...
public class PebbleParallelTagImpl extends ASTWrapperPsiElement implements PebbleParallelTag {

  public PebbleParallelTagImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PebbleVisitor visitor) {
    visitor.visitParallelTag(this);
  }
  ...
  @Override
  @NotNull
  public PebbleEndparallelTag getEndparallelTag() {
    return findNotNullChildByClass(PebbleEndparallelTag.class);
  }
