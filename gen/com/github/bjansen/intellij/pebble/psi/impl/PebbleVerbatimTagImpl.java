...
public class PebbleVerbatimTagImpl extends ASTWrapperPsiElement implements PebbleVerbatimTag {

  public PebbleVerbatimTagImpl(ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public PebbleEndverbatimTag getEndverbatimTag() {
    return findNotNullChildByClass(PebbleEndverbatimTag.class);
  }
