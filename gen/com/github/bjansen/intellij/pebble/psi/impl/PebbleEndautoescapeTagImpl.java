...
public class PebbleEndautoescapeTagImpl extends ASTWrapperPsiElement implements PebbleEndautoescapeTag {

  public PebbleEndautoescapeTagImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PebbleVisitor visitor) {
    visitor.visitEndautoescapeTag(this);
  }
