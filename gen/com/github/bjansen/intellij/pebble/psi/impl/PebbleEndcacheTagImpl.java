...
public class PebbleEndcacheTagImpl extends ASTWrapperPsiElement implements PebbleEndcacheTag {

  public PebbleEndcacheTagImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PebbleVisitor visitor) {
    visitor.visitEndcacheTag(this);
  }
