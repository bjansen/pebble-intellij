...
public class PebbleElseifTagImpl extends ASTWrapperPsiElement implements PebbleElseifTag {

  public PebbleElseifTagImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PebbleVisitor visitor) {
    visitor.visitElseifTag(this);
  }
