...
public class PebbleExtendsTagImpl extends ASTWrapperPsiElement implements PebbleExtendsTag {

  public PebbleExtendsTagImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PebbleVisitor visitor) {
    visitor.visitExtendsTag(this);
  }
