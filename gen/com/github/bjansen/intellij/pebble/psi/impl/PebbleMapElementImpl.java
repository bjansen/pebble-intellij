...
public class PebbleMapElementImpl extends ASTWrapperPsiElement implements PebbleMapElement {

  public PebbleMapElementImpl(ASTNode node) {
    super(node);
  }
  ...
  public PebbleStringLiteral getStringLiteral() {
    return findNotNullChildByClass(PebbleStringLiteral.class);
  }
